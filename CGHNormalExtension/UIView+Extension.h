...
#define SetUpFontWithView(view, fontsize, weightNumber) \
if (@available(iOS 8.2, *)) { \
view.font = [UIView adjustFont:fontsize weight:weightNumber];    \
} else { \
view.font = [UIView adjustFont:fontsize];    \
} \

#define FontL(s) [UIView adjustFont:s weight:UIFontWeightLight]
#define FontR(s) [UIView adjustFont:s weight:UIFontWeightRegular]
#define FontB(s) [UIView adjustFont:s weight:UIFontWeightBold]
#define FontT(s) [UIView adjustFont:s weight:UIFontWeightThin]
#define FontM(s) [UIView adjustFont:s weight:UIFontWeightMedium]
#define Font(s) FontR(s)

#define SystemVersion [UIDevice currentDevice].systemVersion.boolValue
...
#define NAVIGATION_TOP_STATUS_HEIGHT (IS_IPHONE_X ? 24 : 0)
...
/**
 * @brief 将viewController从栈中移除.
 */
+ (void)removeTheViewControllerFromTheNavigationVCs:(UIViewController *)vc;
